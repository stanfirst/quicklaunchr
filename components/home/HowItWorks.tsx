    ...
    <section id="how-it-works" className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[600px] bg-gradient-to-br from-orange-50 to-white rounded-2xl p-6 flex items-center justify-center overflow-hidden">
            <div className="relative w-full h-full max-w-md">
              {/* Step 1: Form Filling Animation */}
              {activeStep === 0 && (
                <div className="absolute inset-0 flex items-center justify-center animate-fade-in">
                  <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm border-2 border-orange-600">
                    <h3 className="text-lg font-bold text-black mb-4">Startup Application</h3>
                    <div className="space-y-4">
                      <div>
                        <label className="text-xs text-gray-500 mb-1 block">Company Name</label>
                        <div className="h-8 bg-gray-100 rounded border border-gray-200 flex items-center px-3">
                      ...
                      <div>
                        <label className="text-xs text-gray-500 mb-1 block">Funding Stage</label>
                        <div className="h-8 bg-gray-100 rounded border border-gray-200 flex items-center px-3">
                          <span className="text-sm text-gray-700">
                      ...
                      <button className="w-full bg-orange-600 text-white py-2 rounded text-sm font-medium mt-4 submit-button">
                        Submit Application
                      </button>
                    </div>
                  </div>
              ...
              {activeStep === 1 && (
                <div className="absolute inset-0 flex items-center justify-center animate-fade-in">
                  <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-sm border-2 border-orange-600">
                    <div className="text-center mb-6">
                      <div className="w-20 h-20 mx-auto mb-4 relative">
                        <div className="absolute inset-0 border-4 border-orange-200 rounded-full"></div>
                        <div className="absolute inset-0 border-4 border-orange-600 rounded-full border-t-transparent animate-spin-slow"></div>
                      ...
                      <h3 className="text-lg font-bold text-black mb-2">Reviewing Application</h3>
                      <p className="text-sm text-gray-600 mb-4">Our team is auditing your startup details</p>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 bg-orange-600 rounded-full animate-pulse"></div>
                        <span className="text-sm text-gray-700">Verifying company details</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 bg-orange-600 rounded-full animate-pulse delay-200"></div>
                        <span className="text-sm text-gray-700">Checking financial records</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-2 h-2 bg-orange-600 rounded-full animate-pulse delay-400"></div>
                        <span className="text-sm text-gray-700">Validating team credentials</span>
                      </div>
              ...
              {activeStep === 2 && (
                <div className="absolute inset-0 flex items-center justify-center animate-fade-in">
                  <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm border-2 border-orange-600">
                    <h3 className="text-lg font-bold text-black mb-4">Finding Matches</h3>
                    <div className="space-y-4">
                      <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-lg border border-orange-200">
                        ...
                        <div className="flex-1">
                          <div className="font-semibold text-sm text-black">Tech Ventures Fund</div>
                          <div className="text-xs text-gray-600">SaaS • Seed Stage • 95% Match</div>
                        </div>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200 opacity-60">
                        ...
                        <div className="flex-1">
                          <div className="font-semibold text-sm text-gray-700">Capital Partners</div>
                          <div className="text-xs text-gray-500">FinTech • Series A • 78% Match</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-lg border border-orange-200 animate-slide-in">
                        <div className="w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center text-white font-bold">
                          I3
                        </div>
                        <div className="flex-1">
                          <div className="font-semibold text-sm text-black">Innovation Capital</div>
                          <div className="text-xs text-gray-600">SaaS • Seed Stage • 92% Match</div>
                        </div>
                        <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                      </div>
                      <div className="mt-4 text-center">
                        <div className="inline-flex items-center gap-2 text-orange-600 text-sm font-medium">
              ...
              {activeStep === 3 && (
                <div className="absolute inset-0 flex items-center justify-center animate-fade-in">
                  <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm border-2 border-orange-600">
                    <h3 className="text-lg font-bold text-black mb-4">Pitch & Negotiate</h3>
                    <div className="space-y-4">
                      <div className="bg-gradient-to-br from-orange-50 to-white rounded-lg p-4 border border-orange-200">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <div className="font-semibold text-sm text-black">Pitch Meeting</div>
                      ...
                      <div className="bg-green-50 rounded-lg p-4 border-2 border-green-500">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div className="flex-1">
                            <div className="font-bold text-black">Deal Closed!</div>
                            <div className="text-xs text-gray-600">Investment Secured</div>
                          </div>
                        </div>
