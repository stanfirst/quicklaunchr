import { getStartupById } from "@/app/actions/startup";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Building2, FileText, TrendingUp, Users, Rocket, CheckCircle2, XCircle, ArrowLeft } from "lucide-react";
...
async function StartupDetailContent({ id }: { id: string }) {
  unstable_noStore(); // Mark this data fetch as uncached
  const startup = await getStartupById(id); // Server action call
...
export async function StartupDetail({ id }: { id: string }) {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-[150px]">
        {/* Back Button */}
        <Link
          href="/startups"
